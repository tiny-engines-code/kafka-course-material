...
public class HelloConsumerFactory {
    public static Properties getConsumerProperties(String groupId) {
        ...
        if (MyConfiguration.value_deserializer.equals(KafkaAvroDeserializer.class)) {
            clientProperties.put(AbstractKafkaAvroSerDeConfig.SCHEMA_REGISTRY_URL_CONFIG, MyConfiguration.registry_url);
