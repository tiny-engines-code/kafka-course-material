...
public class RegistryExample {
    ...
    public static Optional<String> doExample(String topic, Class<?> clazz) {

        try {
            RegistryExample example = new RegistryExample(MyConfiguration.registry_url);
            ...
            Schema localSchema = SchemaBuilder.record("Test").namespace("com.chrislomeli.kafka.common.schema")
                    .fields()
                    .requiredString("userName")
                    .requiredString("emailAddress")
                    .requiredLong("id")
                    .requiredInt("age")
                    .name("birthTime").type(timestampMilliType).noDefault()
                    .endRecord();
