...
/*
 Modified from the NSP example at: https://github.nike.com/NSP/examples/blob/master/producer_consumer/java/src/main/java/com/nike/nsp/examples/producerconsumer/Main.java
